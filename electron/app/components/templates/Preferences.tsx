...
import PrefOSCTabPanel from '../molecules/PrefOSCTabPanel';
import Theme from '../../models/Theme';
// import { Props } from '../../containers/PreferencesPage';

type Props = {
  preferences: PreferencesRecordType;
} & ReturnType<typeof bindActionCreators>;
...
export default function PreferencesComponent(props: Props) {
  const { preferences, onChangePreferences } = props;
  ...
  const onSave = (newPreferences: Preferences) => {
    onChangePreferences(newPreferences);
  };
